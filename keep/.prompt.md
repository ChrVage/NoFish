...
## First prio changes
- Which pictures are required for logos and icons, what size, form and format should they be, what should they be called and where should they be placed? Create two tables in readme-technical.md, one with descriptions and location of each picture, and one with each reference to each picture.
