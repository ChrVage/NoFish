...
## First prio changes
- Set a text on the map when anyone first open the app. "Click on the map to get fishing scores, forecasts or tide levels on the Norwegian coast, or click 'My location' to get the details for your location." The text should be visible until the user starts interacting with the application. If location permission is already granted, the text should not be displayed.
- In the statistics page, add municipalities searched in the last week, four weeks and 13 weeks.
