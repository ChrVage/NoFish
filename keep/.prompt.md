...
- Set a text on the map when anyone first open the app. "Click on the map to get fishing scores, forecasts or tide levels on the Norwegian coast". The text should be visible until the user starts interacting with the application.
