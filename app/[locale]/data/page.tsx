      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-lg" style={{ padding: '2rem 1.5rem' }}>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
            <p className="text-sm text-amber-900 font-bold mb-1">{t('disclaimer.title')}</p>
            <p className="text-sm text-amber-800">
              {t.rich('disclaimer.text', { strong: (c) => <strong>{c}</strong> })}
            </p>
          </div>
          ...
          <div className="prose prose-sm max-w-none text-gray-700 space-y-8">
              ...
              <div className="overflow-x-auto">
                <table className="text-xs w-full">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    ...
                    <tr><td className="py-1.5 pr-3 font-bold">Wind dir</td><td className="py-1.5 pr-3">wind barb</td><td className="py-1.5">Meteorological wind barb — shows both direction and strength in a single symbol. The shaft points <strong>toward</strong> where the wind is heading; barbs at the tail encode speed: half barb = 5 kn, full barb = 10 kn, pennant = 50 kn. Calm winds show an open circle. Hover/aria label shows direction and Beaufort force.</td></tr>
            ...
            <section className="mt-6">
              <p className="text-sm text-gray-500">
                See <Link href={scoreAboutHref} className="text-maritime-teal-600 underline">Fishing Score Algorithm</Link> for how these values feed into the fishing score.
              </p>
            </section>
          </div>
