...
export default async function ScoreAboutPage({ params }: PageProps) {
      ...
      <main className="max-w-3xl mx-auto w-full min-w-0 px-4 py-8">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden" style={{ padding: '2rem 1.5rem' }}>
          ...
          <div className="prose prose-sm max-w-none text-gray-700 space-y-6 break-words [overflow-wrap:anywhere] [&_table]:w-full [&_th]:whitespace-normal [&_td]:whitespace-normal [&_th]:align-top [&_td]:align-top">
            ...
            <section>
              <h2 className="text-lg font-bold text-maritime-teal-800 mt-6 mb-2">{t('design.heading')}</h2>
              <p>
...
totalScore   = round( safetyScore × fishingScore / 100 )`}</code></pre>
            ...
            {/* Safety Factors */}
            <section>
              <h2 className="text-lg font-bold text-maritime-teal-800 mt-8 mb-3">{t('safety.heading')}</h2>
            ...
            {/* Fishing Factors */}
            <section>
              <h2 className="text-lg font-bold text-maritime-teal-800 mt-8 mb-3">{t('fishing.heading')}</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-maritime-teal-800 mt-8 mb-2">{t('windows.heading')}</h2>
              <p className="text-sm">
            ...
            {/* Score Colour Coding */}
            <section>
              <h2 className="text-lg font-bold text-maritime-teal-800 mt-8 mb-2">{t('colours.heading')}</h2>
              <div className="overflow-x-auto">
                <table className="text-xs w-full mt-1">
            ...
            <section className="mt-6">
              <p className="text-sm text-gray-500">
                See <Link href={dataHref} className="text-maritime-teal-600 underline">Data Column Reference</Link> for source ratings and column descriptions.
              </p>
            </section>
          </div>
