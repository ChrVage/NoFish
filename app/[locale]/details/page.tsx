          ...
          <div className="mb-6">
              ...
              <div className="mt-2 space-y-0.5">
                ...
                {tideStationDistance !== null && tideStationLat !== undefined && tideStationLng !== undefined && (
                  <p className="text-xs text-gray-400">
                    ...
                    {` · `}{t('nearestStation', { distance: formatDistance(tideStationDistance) })}
            ...
            {!isLand && (isDark || civilTwilightEnd) && (
              <p className="mt-2 text-sm text-amber-800">
                {isDark ? (
                  <span className="font-semibold">{t('currentlyDark')}</span>
                ) : civilTwilightEnd && (() => {
                    ...
                    return (
                      <span key={i} className="text-red-800">
                        ...
                        <span style={{ fontWeight: 700 }}>
                          {isCurrent ? t('nowWarning') : `${timeFmtHHMM.format(new Date(entry.time))}:`}
                        </span>
                        {' '}
                        {cleaned.join(', ')}
                      </span>
